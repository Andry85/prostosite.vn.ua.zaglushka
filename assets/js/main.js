 ...
 function checkForChanges() {
    if ($('.content-message').hasClass('active-slide'))
        ...
        setTimeout(function() {
            ...
            $('#text-alert').text('Насолоджуйтесь відвідуванням...').addClass('fadeIn')
...
$(window).load(function() {
    ...
    $('#text-alert').text('Хтось пише вам...');

    $('a.messages').addClass('ion-chatbubble-working').removeClass('');

    setTimeout(function() {
        $('#text-alert').text('Подивіться! Ви отримали 1 нове повідомлення.').addClass('fadeIn');
